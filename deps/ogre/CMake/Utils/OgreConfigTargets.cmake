...
function(ogre_config_lib LIBNAME EXPORT)
  ...
  if (OGRE_STATIC)
    ...
    set_target_properties(${LIBNAME} PROPERTIES COMPILE_FLAGS "${OGRE_GCC_VISIBILITY_FLAGS} -fPIC")
  else (OGRE_STATIC)
...
function(ogre_config_plugin PLUGINNAME)
  ...
  if (OGRE_STATIC)
    ...
    if (CMAKE_COMPILER_IS_GNUCXX OR CMAKE_COMPILER_IS_CLANGXX)
      # add GCC visibility flags to shared library build
      set_target_properties(${PLUGINNAME} PROPERTIES COMPILE_FLAGS "${OGRE_GCC_VISIBILITY_FLAGS} -fPIC")
